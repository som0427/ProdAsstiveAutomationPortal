...
#  | Custom Phone Number                                       |
  ...
  Scenario Outline: user will open workflow section of a item from the Workflows list and will add Send App Notification Action
    ...
    Examples:
      | To Receiver | Title | Message                 | Workflow Name | ActionNodeConditionType |
      | Owner       | Grips | Can not create customer |               |                         |

#    Data Table:
#    |       Choose To Receiver Data         |  Choose ActionNodeConditionType |
#    | Owner,Reporting Manager,Selected User |  YES                            |
#    | Owner                                 |  NO                             |
#    | Reporting Manager                     |
#    | Selected User                         |
...
#      |               | Gender                           | About                               | Created Date                    |                 |                       |                           |
  ...
  Scenario Outline: user will open workflow section of a item from the Workflows list and will add Approval
    ...
    Examples:
      | Workflow Name | ActionNodeConditionType | Name | Assign To                                            | Enable Editing | Role  |
